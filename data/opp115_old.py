...
class OPP115:
	...
	def __init__(self):
		...
		print(self.consolidated['data_practice'].value_counts())
	...
	def partition(self, annotations):
		...
		#df = pd.DataFrame(columns=['data_practice'])
		#df['data_practice'] = y_train
		#print(df['data_practice'].value_counts())

		#df = pd.DataFrame(columns=['data_practice'])
		#df['data_practice'] = y_test
		#print(df['data_practice'].value_counts())
